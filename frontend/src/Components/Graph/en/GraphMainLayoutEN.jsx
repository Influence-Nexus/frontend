...
import { GraphComponentEN } from './GraphComponentEN';
...
import { cards, cardcreds } from '../../Solar/en/ModalWindowCards/cardsEN';
...
export const GraphMainLayoutEN = ({ setHeaderShow }) => {
  useEffect(() => {
    setHeaderShow(true);
  }, [setHeaderShow]);
  const {
...
export default GraphMainLayoutEN;
