    ...
    <div className="AlgoPage-main-div">
      <div className="algoPage-submain-div">
        ...
        <div className="Description-text">
          ...
          <ul>
            <li><p><span>уникальность и неповторяемость</span> ситуаций принятия решений;</p></li>
            <li><p>факторы и связи <span>не поддаются наблюдению</span> и измерению; отсутствуют даже единичные экземпляры данных;</p></li>
            <li><p>картина взаимосвязей <span>субъективна</span> и зависит от мировоззренческой позиции лица, принимающего решение (ЛПР).</p></li>
          </ul>
          ...
          <p>Окружности — факторы, стрелки — связи, числа рядом — веса связей.</p>

          <p><strong>Основная идея:</strong> система установок и убеждений человека предопределяет его стратегическую реакцию на изменения среды.</p>

          <p><strong>Стратегическое решение</strong> — это <span className="blue-text">набор управляющих воздействий</span>, приводящих к желаемому изменению состояния системы (отклика).</p>
          ...
          <p>Алгоритм основан на спектральных свойствах матрицы смежности графа и не ограничен знаком или весами ребер.</p>
          <p>Сценарии оцениваются на основе сонаправленности отклика относительно базового вектора.</p>
          ...
          <p><strong>Графическая интерпретация передачи влияний:</strong></p>
          ...
          <ul>
            ...
            <li><p>x — приращение отклика вершины в момент t;</p></li>
            <li><p>u — управляющее воздействие на вершину v;</p></li>
            <li><p>a — вес дуги между вершинами;</p></li>
            <li><p>нижний индекс — номер вершины;</p></li>
