      ...
      <div className="algoPage-submain-div">
        ...
        <div className="Description-text">
          ...
          <ul>
            <li>
              <p>
                executive decisions of a president during a (financial, social,
                military) crisis;
              </p>
            </li>
            <li>
          ...
          <p>
            ...
            directed, weighted, signed graph with deterministic causality on its
            edges. Nodes are institutional factors; edges are causal connections
            with weights from –1 to +1.
          </p>
          ...
          <div style={{ textAlign: 'center', marginTop: '20px' }}>
            <p>
              ...
              during the propagation of causal influences along graph edges
            </p>
          </div>
