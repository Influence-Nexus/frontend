...
export const RulesPageEng = ({ setHeaderShow }) => {
  setHeaderShow = true;
  return (
      ...
      <ol type="A" id="letter-list-uncolored">
        <li>
          ...
          <div id="sub-list-colored-div">
            ...
            <p id="spanned-list-header-p">Scenario Model Description</p>
          </div>
          <br />
          <p>The player reviews a representation of a real-world situation.</p>
          ...
          <ol id="num-list-uncolored">
            ...
            <li>
              <p>
                <strong>Identify and highlight</strong> (per the task) the
                target node—i.e., the node that should achieve the maximum
                response when other nodes are influenced.
              </p>
            </li>
            <li>
              <p>
          ...
          <h3 style={{ fontSize: '1.75rem' }}>
            ...
            . The{' '}
            <span style={{ fontStyle: 'italic' }}>“Crime and Punishment”</span>{' '}
            model
          </h3>
          <br />
          <ol id="num-list-uncolored">
          ...
          <ol start={3} id="num-list-uncolored">
            <li>
              <p>The nodes are connected by edges (arrows) with weights.</p>
            </li>
            <li>
              <p>
                The target node in this model is node 3, “Theft.” The goal is to
                maximize node 3’s response by influencing other nodes, without
                directly affecting node 3.
              </p>
            </li>
          </ol>
          <p>
            ...
            increasing{' '}
            <span style={{ fontStyle: 'italic' }}>Police Presence</span> reduces{' '}
            <span style={{ fontStyle: 'italic' }}>Theft</span> (and vice versa).
          </p>
          <br />
          <br />
          <div id="sub-list-colored-div">
        ...
        <li>
          ...
          <br />
          <p>
            Atlas Strategos is an experienced influencer whose behavior reflects
            wisdom and calculated intelligence.
          </p>
          <br />
          <p>
          ...
          <p>
            ...
            to maximize the model’s response. Society typically cannot influence
            all nodes at once.
          </p>
          <br />
          <p>
          ...
          <ol id="num-list-uncolored">
            <li>
              <p>
                A move consists of selecting a sequence of nodes to influence in
                that turn.
              </p>
            </li>
            <li>
              <p>You must select at least three nodes each turn.</p>
            </li>
            <li>
              <p>
          ...
          <ol id="num-list-uncolored">
            ...
            <li>
              <p>The timer ends the game when time runs out.</p>
            </li>
            <li>
              <p>
          ...
          <br />
          <p style={{ textDecoration: 'underline' }}>Scoring Rules</p>
          ...
          <ol id="num-list-uncolored">
            ...
            <li>
              <p>
                For near-correct rankings—plus 20–50% of the points from point
                1.
              </p>
            </li>
            <li>
