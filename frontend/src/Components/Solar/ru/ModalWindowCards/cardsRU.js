...
export const modelcards = {
  ...
  'dffd4a9f-ed6d-4953-9d11-4106af5ba401':
    'Жизнеобеспечение_в_городских_и_периферийных_районах,_не_связанных',
  '9dc56d36-9785-4237-b442-6203ce87fd7b': 'Риск_разрушительных_лесных_пожаров',
  'aaa88c40-34f7-4141-9282-eb79d0eae8dc': 'Затраты на реализацию',
  '32a2cd0c-e90a-41d8-849d-3b7bac87fd13':
    'Приоритизация_закупок_ИТ_услуг_в_госсекторе',
  'fee0b37b-33bf-4bf4-bfc0-b64ac01aa24e':
    'Влияние_изменения_климата_на_услуги_прогулочных_катаний_на_лодках',
  '8f7a7735-72fb-449d-92c6-0d6f08ef2397':
    'Клинический_риск_при_администрировании_медикаментозной_терапии',
  '274070c4-4e4c-4390-896c-fa001ebac815':
    'Финансовый_кризис_из_за_отсутствия_демократии',
  '8c86ca26-79c7-49f2-beb5-c0e149e379f6':
    'Оценка_операционной_эффективности_бизнеса_через_долю_рынка',
  '6c6b7677-1245-4b7e-9ff9-b41162165ab3':
    'Жизнеобеспечение_животноводческих_систем,_основанных_на_разведении',
  '68ed3011-111e-47cf-b0c9-295ee75dbb32':
    'Качество_и_доступность_среды_обитания',
  '3cf6203d-08bb-4a35-8f80-82dca78e9ffb':
    'Жизнеобеспечение_смешанных_сельскохозяйственных_систем,_основанных',
  'eb8a443a-1132-4127-9923-0333663f5ead':
    'Воздействие_изменения_климата_на_производство_дикого_риса',
  '3d74ea97-2fc6-4118-8330-5eb6ebd253e4':
    'Влияние_изменения_климата_на_коммерческое_рыболовство',
  '70f4a174-c058-4306-8132-ac3e9228e7ee': 'Энергетический переход',
  'b7f3df4a-7dc9-4654-b6dd-c8c35f7780bf':
    'Американская_версия_Карибского_кризиса_1962_года',
  'e324515b-3ee7-432d-9e00-25dd9c684d31': 'Выбор научной конференции',
  '0a899fa4-f0f4-420b-bfc7-e37c48b348eb':
    'Надежность_и_безопасность_автомобиля',
  'dd4ffb5a-6189-41d0-a566-f6979dcdf6cf': 'Устойчивость предприятия',
  'ae857ab6-63b8-48db-b015-f613111076ea': 'Проблема бездомности',
  'c73454c7-af30-4965-87b8-a6a7d4562481': 'Преступление и наказание',
  '6e85f59b-2a46-44b5-9b5a-31f572504622':
    'Связывание_углерода_в_связи_с_изменениями_климата',
  'e21c1cb3-1888-42c7-8a05-4b1a879c234b':
    'Качество_менеджмента_в_строительстве_и_взаимоотношения_с_клиентом',
  '473ef493-1b00-4a48-be4c-4a109c9bc132':
    'Вырубка_лесов_в_сельской_горной_местности',
  '8a37c683-d10b-4bf3-a432-99ce5447c44f':
    'Влияние_изменения_климата_на_спортивное_рыболовство',
  '59ed38a9-d8a0-49cf-8dfc-7e5a2e8bcf03': 'Управление знаниями персонала',
  '0244975d-12cf-4439-be50-ce7a7f7a10f0':
    'Урожайность_озимой_пшеницы_в_условиях_богарного_земледелия',
  '591e5ad4-0b6b-4280-9fee-9756eb1abbe0':
    'Влияние_изменения_климата_на_безопасное_жизненное_пространство_человечества',
};
...
export const cards = {
  Green: [
    {
      ...
      damping: 1.0,
      n_0: ['C8'],
      n_pos: ['C9 Донорское продовольствие'],
      n_neg: [],
    ...
    },
    {
      ...
      title:
        'Влияние изменения климата на безопасное жизненное пространство человечества',
      description:
    ...
    },
    {
      ...
      n_0: [],
      n_pos: [
        'C8 Habitat Quality and Availability (C8 Качество и доступность мест обитаний)',
      ],
      n_neg: [],
      link: 'https://dx.doi.org/10.7302/4364',
    ...
    },
    {
      ...
      damping: 0.7,
      n_0: [],
      n_pos: ['C4. Biodiversity Loss (С4. Глобальное потепление)'],
      n_neg: [],
      link: 'https://dx.doi.org/10.7302/4364',
    ...
    },
    {
      ...
      damping: 1.0,
      n_0: [],
      n_pos: ['C9 Sport fishing (C9 Спортивная рыбалка)'],
      n_neg: [],
      link: 'https://dx.doi.org/10.7302/4364',
    ...
    },
    {
      ...
      title:
        'Влияние изменения климата на услуги прогулочных катаний на лодках',
      description:
      ...
      damping: 1.0,
      n_0: [],
      n_pos: ['C8 Recreational boating (Прогулочное катание на лодках)'],
      n_neg: [],
      link: 'https://dx.doi.org/10.7302/4364',
    ...
    },
    {
      ...
      damping: 1.0,
      n_0: [],
      n_pos: ['C8 Wild rice production (Производство дикорастущего риса)'],
      n_neg: [],
      link: 'https://dx.doi.org/10.7302/4364',
    ...
    },
    {
      ...
      n_0: [],
      n_pos: [
        'C1 Potential yield level (С1 Потенциальный уровень урожайности )',
      ],
      n_neg: [],
    ...
    },
    {
      ...
      damping: 0.5,
      n_0: [],
      n_pos: ['С12. High-intensity fire (Пожар высокой интенсивности)'],
      n_neg: [],
    ...
    },
    {
      ...
      damping: 0.8,
      n_0: [],
      n_pos: ['C15. Landslide occurrence (Возникновение оползней)'],
      n_neg: [],
  ...
  Violet: [
    {
      ...
      title:
        'Жизнеобеспечение животноводческих систем, основанных на разведении крупного рогатого скота',
      description:
      ...
      n_0: ['C8'],
      n_pos: [
        'C8 - Food in household (Питание в домохозяйстве (обеспечение домохозяйства продовольствием))',
      ],
      n_neg: [],
    ...
    },
    {
      ...
      title:
        'Жизнеобеспечение смешанных сельскохозяйственных  систем, основанных на растениеводстве и мелком животноводстве',
      description:
      ...
      n_0: ['C8'],
      n_pos: [
        'C8 - Food in household(Продукты питания в домохозяйстве (обеспечение домохозяйства продовольствием))',
      ],
      n_neg: [],
      link: 'https://doi.org/10.5751/ES-04393-160408',
    ...
    },
    {
      ...
      title:
        'Жизнеобеспечение в городских и периферийных районах, не связанных с сельским хозяйством',
      description:
      ...
      damping: 1.0,
      n_0: ['C5'],
      n_pos: ['С13 Общий урожай(Total harvest)'],
      n_neg: [],
      link: 'https://doi.org/10.5751/ES-04393-160408',
    ...
    },
    {
      ...
      title:
        'Качество менеджмента в строительстве и взаимоотношении с клиентом',
      description:
  ...
  Orange: [
    ...
    },
    {
      ...
      title:
        'Финансовый кризис, связанный с иностранными спекулятивными инвестициями',
      description:
      ...
      damping: 0.5,
      n_0: ['C1', 'C5', 'C8', 'C9', 'C15', 'C17', 'C22', 'C23'],
      n_pos: ['C9'],
      n_neg: ['C9'],
