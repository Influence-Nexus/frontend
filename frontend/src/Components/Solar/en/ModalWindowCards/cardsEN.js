...
export const modelcards = {
  ...
  '32a2cd0c-e90a-41d8-849d-3b7bac87fd13':
    'Impact of IT services on economic development spending',
  'fee0b37b-33bf-4bf4-bfc0-b64ac01aa24e':
    'The Impact of Climate Change on Recreational Boating Services',
  '8f7a7735-72fb-449d-92c6-0d6f08ef2397':
    'Clinical risk in drug administration',
  ...
  'eb8a443a-1132-4127-9923-0333663f5ead':
    'The impact of climate change on wild rice production',
  '3d74ea97-2fc6-4118-8330-5eb6ebd253e4':
    'The Impact of Climate Change on Commercial Fishing',
  '70f4a174-c058-4306-8132-ac3e9228e7ee': 'Energy Transition',
  'b7f3df4a-7dc9-4654-b6dd-c8c35f7780bf':
    'U.S. actions in the Cuban missile crisis',
  ...
  '473ef493-1b00-4a48-be4c-4a109c9bc132':
    'Deforestation in a rural mountainous area',
  '8a37c683-d10b-4bf3-a432-99ce5447c44f':
    'The Impact of Climate Change on Sport Fishing',
...
export const cards = {
  Green: [
    ...
    },
    {
      ...
      paper:
        'García, C.G., Ortiz, I.P. (2014). Stability Analysis of Climate System Using Fuzzy Cognitive Maps. In: Obaidat, M., Filipe, J., Kacprzyk, J., Pina, N. (eds) Simulation and Modeling Methodologies, Technologies and Applications. Advances in Intelligent Systems and Computing, vol 256. Springer, Cham.',
    ...
    },
    {
      ...
      description: 'Habitat quality and availability.',
      paper:
        'Huber, J., Shrethsa, P., Vander Bilt, L., Nowicki, A.: Using Fuzzy Cognitive Mapping to Assess the Impacts of Climate Change on Great Lakes Ecosystem Services. (2022). Completed in partial fulfillment of the requirements for the degree of Master of Science in the University of Michigan, April 202',
      link: 'https://dx.doi.org/10.7302/4364',
    ...
    },
    {
      ...
      description:
        'The model examines the process of winter wheat yield formation during plant photosynthesis under specific soil and climatic conditions using dryland farming technology with zero tillage (No-Till). This technology relies on the operator’s and agronomic machinery operator’s expertise, timely application of soil amendments, and soil surface mulching to protect against erosion and promote moisture retention.',
      paper:
    ...
    },
    {
      ...
      paper:
        'Malek, Ž.: Fuzzy-Logic Cognitive Mapping: Introduction and Overview of the Method. In: Environmental Modeling with Stakeholders. pp. 127–143. Springer International Publishing, Cham (2017).',
  ...
  Violet: [
    ...
    },
    {
      ...
      paper:
        'Rotshtein, A.Р.: Fuzzy cognitive maps in the dependability analysis of systems. Dependability. 19, 24–31 (2019).',
    ...
    },
    {
      ...
      paper:
        'Xirogiannis, G., Glykas, M.: Fuzzy Cognitive Maps in Business Analysis and Performance-Driven Change. IEEE Trans. Eng. Manag. 51, 334–351 (2004).',
    ...
    },
    {
      ...
      paper:
        'Mazzuto, G., Stylios, C., Ciarapica, F.E., Bevilacqua, M., Voula, G.: Improved Decision-Making through a DEMATEL and Fuzzy Cognitive Maps-Based Framework. Math. Probl. Eng. 2022, 1–14 (2022).',
    ...
    },
    {
      ...
      paper:
        'Kadaifci, C., Asan, U., Topcu, Y.I.: A Fuzzy Cognitive Mapping Approach to the Conference Selection Problem. Int. J. Inf. Technol. Decis. Mak. 19, 1451–1484 (2020).',
    ...
    },
    {
      ...
      paper:
        'Case, D.M., Blackburn, T., Stylios, C.: Modelling Construction Management Problems with Fuzzy Cognitive Maps. In: Fuzzy Hybrid Computing in Construction Engineering and Management. pp. 413–449. Emerald Publishing Limited (2018).',
  ...
  Orange: [
    ...
    },
    {
      ...
      paper:
        'Sergeev, V.M., Akimov, V.P., Lukov, V.B., Parshin, P.B.: Interdependence in a Crisis Situation. J. Conflict Resolut. 34, 179–207 (1990).',
    ...
    },
    {
      ...
      paper:
        'Kim, D.-H.: Cognitive Maps of Policy Makers on Financial Crises of South Korea and Malaysia: A Comparative Study. Int. Rev. Public Adm. 9, 31–38 (2004).',
    ...
    },
    {
      ...
      paper:
        'Choi, Y., Lee, H., Irani, Z.: Big data-driven fuzzy cognitive map for prioritising IT service procurement in the public sector. Ann. Oper. Res. 270, 75–104 (2018).',
